...
namespace BusinessLogic.Migrations.PurchaseOrder
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddress_Department = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PaymentAttempt = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseOrdersId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItems_PurchaseOrders_PurchaseOrdersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_PurchaseOrdersId",
                table: "OrderItems",
